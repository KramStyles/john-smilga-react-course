  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <button
          className="btn btn-lg btn-outline-primary m-auto d-block mt-3 mb-3"
          onClick={() => setValue((prev) => prev + 1)}
        >
          Click to increment value and window title
        </button>
        <p className="text-center fs-1">
          Window Width: <span className="text-primary">{size}px</span>
        </p>
      </div>
    </>
  );
